...
public class Aylyk_list extends VBox {
    public Aylyk_list() throws SQLException {
        ...
        gormek.setOnAction((e->{
            Global.main_hbox.getChildren().clear();
            try {
                Global.main_hbox.getChildren().addAll(new Ay_boyunca_aylyk((String) ayboyunca.getSelectionModel().getSelectedItem()));
        ...
        has_box.getChildren().addAll(uytgetmekbox,new Aylyk_tablitsa());
